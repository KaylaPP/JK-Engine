...
class ShowStatState extends MusicBeatState
{
    ...
    public function new(sicks:Int, cools:Int, goods:Int, bads:Int, craps:Int, shits:Int, misses:Int, bombs:Int, score:Int, gotHighScore:Bool, accuracy:Float, initSongName:String, songDifficulty:String, rank:String)
    {
        super();
